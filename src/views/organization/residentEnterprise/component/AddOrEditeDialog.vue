      ...
      <el-row :gutter="15">
        <el-col :span="12">
          <el-form-item label="企业负责人姓名" prop="leadingCadre">
            <el-input v-model="form.leadingCadre" placeholder="请输入企业负责人姓名" maxlength="30" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="15">
        <el-col :span="12">
          <el-form-item label="企业规模" prop="companySize">
            <el-select style="width: 100%" v-model="form.companySize" placeholder="请选择企业规模">
        ...
        <el-col :span="12">
          <el-form-item label="是否为装卸作业企业" prop="companyType">
            <el-select style="width: 100%" v-model="form.companyType" placeholder="请选择是否为装卸作业企业">
      ...
      <el-row :gutter="15">
        <el-col :span="24">
          <el-form-item label="企业经营范围" prop="businessScope">
            <el-input type="textarea" :rows="3" v-model="form.businessScope" placeholder="请输入企业经营范围" />
          </el-form-item>
        </el-col>
      </el-row>
